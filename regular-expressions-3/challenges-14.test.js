...
const toTitleCase = (arr) => {
  return arr.map(str => str.substring(0,1).toUpperCase() + str.substring(1));
}
...
const biggerThanLuke = (arr) => {
  return arr.filter(obj => parseInt(obj.mass) > parseInt(arr.find(obj => obj.name === 'Luke Skywalker').mass))
